...
def euler_sir(beta, gamma, S0, I0, R0, t, N):
    ...
    for n in range(len(t) - 1):
        ...
        dS = (-beta*I0*S0)/N  # FILL IN BASED ON SIR MODEL
        dI = (beta*I0*S0)/N - gamma*I0  # FILL IN BASED ON SIR MODEL
        dR = (gamma/I0)  # FILL IN BASED ON SIR MODEL
        S[n + 1] = S0 + dS*t   # FILL IN BASED ON EULER'S METHOD
        I[n + 1] = I0 + dI*t # FILL IN BASED ON EULER'S METHOD
        R[n + 1] = R0 + dR*t # FILL IN BASED ON EULER'S METHOD
    return S, I, R
